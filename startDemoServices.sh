...
nohup spark-submit --class com.hortonworks.iot.spark.streaming.SparkNostradamus --master yarn /home/spark/DeviceMonitorNostradamus-0.0.1-SNAPSHOT-jar-with-dependencies.jar 2>&1 $ROOT_PATH/DeviceMonitorNostradamus.log &
